...
class Task(BaseTask):
    def teste_1_calendario(self):
        binary = self.compile(["calendario.c"])
        self.test_cases(binary, self.case_range("calendario{}.in", 1, 12))

    def teste_2_diferenca(self):
        binary = self.compile(["diferenca.c"])
        self.test_cases(binary, self.case_range("diferenca{}.in", 1, 25))

    def teste_3_sela(self):
        binary = self.compile(["sela.c"])
        self.test_cases(binary, self.case_range("sela{}.in", 1, 12))
