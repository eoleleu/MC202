...
class Task(BaseTask):
    def teste_1_pequeno(self):
        binary = self.make("selecionar")
        self.test_cases(binary, self.case_range("exemplo{}.in", 1, 2))
        self.test_cases(binary, self.case_range("selecionar{}.in", 1, 5))

    def teste_2_medio(self):
        binary = self.make("selecionar")
        self.test_cases(binary, self.case_range("selecionar{}.in", 6, 9))

    def teste_3_grande(self):
        binary = self.make("selecionar")
        self.test_cases(binary, self.case_range("selecionar{}.in", 10, 15))
