...
class Task(BaseTask):
    def teste_1_simples(self):
        binary = self.make("buscador")
        self.test_cases(binary, self.case_range("simples{}.in", 1, 4))

    def teste_2_dupla(self):
        binary = self.make("buscador")
        self.test_cases(binary, ["exemplo.in"])
        self.test_cases(binary, self.case_range("dupla{}.in", 1, 4))

    def teste_3_geral(self):
        binary = self.make("buscador")
        self.test_cases(binary, self.case_range("geral{}.in", 1, 3))
