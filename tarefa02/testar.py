...
class Task(BaseTask):
    def teste_1_classificar_ordenado(self):
        binary = self.make("classificar")
        self.test_cases(binary, self.case_range("homonimos{}.in", 1, 4))

    def teste_2_classificar_desordenado(self):
        binary = self.make("classificar")
        self.test_cases(binary, self.case_range("homonimos{}.in", 5, 8))

    def teste_3_consultas_registrar(self):
        binary = self.make("consultas")
        self.test_cases(binary, self.case_range("consultas{}.in", 1, 4))

    def teste_4_consultas_remover(self):
        binary = self.make("consultas")
        self.test_cases(binary, self.case_range("consultas{}.in", 5, 8))

    def teste_5_consultas_alterar(self):
        binary = self.make("consultas")
        self.test_cases(binary, self.case_range("consultas{}.in", 9, 12))

    def teste_6_classificar_parentes(self):
        binary = self.make("classificar")
