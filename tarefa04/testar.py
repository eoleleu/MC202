...
class Task(BaseTask):
    def teste_1_digitar(self):
        binary = self.make("editor")
        self.test_cases(binary, self.case_range("digitar{}.in", 1, 4))

    def teste_2_destacar(self):
        binary = self.make("editor")
        self.test_cases(binary, ["exemplo.in"])
        self.test_cases(binary, self.case_range("destacar{}.in", 1, 3))

    def teste_3_tudo_pequeno(self):
        binary = self.make("editor")
        self.test_cases(binary, self.case_range("tudo_pequeno{}.in", 1, 2))

    def teste_4_tudo_grande(self):
        binary = self.make("editor")
        self.test_cases(binary, self.case_range("tudo_grande{}.in", 1, 2))
